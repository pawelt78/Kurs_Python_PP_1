from PP_Programowanie_obiektowe_2.Dziedziczenie.shop.order import Order
from PP_Programowanie_obiektowe_2.Polimorfizm.shop.discount_policy import DiscountPolicy
...
class ExpressOrder(Order):
    ...
    def __str__(self):
        ...
        delivery_date = f"Termin dostawy to {self.delivery_date}\n"
